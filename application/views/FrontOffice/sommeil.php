...
<section>
  ...
  <!--/.bg-holder-->
  <h2 style="margin-left: 12%;">Répos</h2><br>
    ...
    <div class="row">
      <div class="col-sm-6 col-lg-3 mb-4">
        <div class="card h-100 shadow card-span rounded-3"><img class="card-img-top rounded-top-3" src=<?php echo site_url("assets/img/gallery/fessier.jpg"); ?> alt="news" />
          <div class="card-body"><span class="fs--1 text-primary me-3">Sommeil</span>
            ...
            </svg><span class="fs--1 text-900"><?php echo $sommeil; ?> heure</span><span class="fs--1"></span>
            <h5 class="font-base fs-lg-0 fs-xl-1 my-3">Un bon sommeil regulier est important pour votre developpement</h5>
          </div>
        </div>
      </div>            
    </div>
