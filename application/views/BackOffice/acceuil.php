...
<html
  ...
  data-assets-path=<?php echo site_url("asset/"); ?>
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          <div class="app-brand demo">
            <a href="index.html" class="app-brand-link">
              ...
              <span class="app-brand-text demo menu-text fw-bolder ms-2">Ekaly</span>
            </a>
          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item">
              <a href="javascript:void(0);" class="menu-link menu-toggle">
                ...
                <div data-i18n="Layouts">Credit</div>
              </a>
              ...
              <ul class="menu-sub">                
                <li class="menu-item">
                  ...
                  >
                    <div data-i18n="Fluid">Ajout credit</div>
                  </a>
                </li>
                <li class="menu-item">
                  <a href="<?php echo site_url("Admin/pagecarte"); ?>" class="menu-link">
                    <div data-i18n="Fluid">Validation credit</div>
                  </a>
                </li>
              </ul>
            </li>
            ...
            <li class="menu-item">
              ...
              >
                ...
                <div data-i18n="Account Settings">Les utilisateurs</div>
              </a>              
            </li>
            <li class="menu-item">
              <a href="javascript:void(0);" class="menu-link menu-toggle">
                <i class="menu-icon tf-icons bx bxl-apple"></i>
                <div data-i18n="Authentications">Alimentation</div>
              </a>
              <ul class="menu-sub">
                <li class="menu-item">
                  <a href="<?php echo site_url("Aliment"); ?>" class="menu-link" target="_blank">
                    <div data-i18n="Basic">Liste aliment</div>
                  </a>
                </li>
                <li class="menu-item">
                  ...
                  >
                    <div data-i18n="Basic">Ajout aliment</div>
                  </a>
                </li>                
              </ul>
            </li>
            <li class="menu-item">
              <a href="javascript:void(0);" class="menu-link menu-toggle">
                ...
                <div data-i18n="Misc">Activité</div>
              </a>
              <ul class="menu-sub">
                <li class="menu-item">
                  <a href="pages-misc-error.html" class="menu-link">
                    <div data-i18n="Error">Les activites existant</div>
                  </a>
                </li>
                <li class="menu-item">
                    ...
                    <div data-i18n="Under Maintenance">Ajout activité</div>
                  </a>
                </li>
              </ul>
            </li>
            <li class="menu-item">
              <a href="javascript:void(0);" class="menu-link menu-toggle">
                ...
                <div data-i18n="Misc">Regime</div>
              </a>
              <ul class="menu-sub">
                <li class="menu-item">
                  <a href="pages-misc-error.html" class="menu-link">
                    <div data-i18n="Error">Liste regime</div>
                  </a>
                </li>
                <li class="menu-item">
                  <a href="pages-misc-under-maintenance.html" class="menu-link">
                    <div data-i18n="Under Maintenance">Ajout regime</div>
                  </a>
                </li>
              </ul>
            </li>
        ...
        <div class="layout-page">
              ...
              <ul class="navbar-nav flex-row align-items-center ms-auto">
                ...
                <li class="nav-item lh-1 me-3">
                  <a
                    ...
                    data-icon="octicon-star" data-size="large" data-show-count="true" aria-label="Star themeselection/sneat-html-admin-template-free on GitHub" >Star</a>
                </li>
                ...
                <li class="nav-item navbar-dropdown dropdown-user dropdown">
                  <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);" data-bs-toggle="dropdown">
                    <div class="avatar avatar-online">
                      <img src=<?php echo site_url("asset/img/avatars/1.png"); ?> alt class="w-px-40 h-auto rounded-circle" />
                    </div>
                  </a>
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              ...
              <div class="row">
                  <?php $this->load->view('BackOffice/'.$page); ?>
              </div>
            </div>
            <!-- / Content -->
            <!-- Footer -->
            <footer class="content-footer footer bg-footer-theme">
              <div class="container-xxl d-flex flex-wrap justify-content-between py-2 flex-md-row flex-column">
                <div class="mb-2 mb-md-0">
                  ...
                  <a href="#" target="_blank" class="footer-link fw-bolder">Us</a>
                </div>
              </div>
            </footer>
            <!-- / Footer -->
                          ...
                          <div class="modal-dialog modal-dialog-centered" role="document">
                            ...
                            <form action="<?php echo site_url("Carte/insertcarte"); ?>" method="post">  
                              <div class="modal-header">
                                <h5 class="modal-title" id="modalCenterTitle">Nouvelle carte</h5>
                                <button
                                  type="button"
                                  class="btn-close"
                              ...
                              <div class="modal-body">
                                ...
                                <div class="row g-2">
                                  <div class="col mb-0">
                                    <label for="emailWithTitle" class="form-label">Valuer</label>
                                    <input
                                      type="text"
                                      id="emailWithTitle"
                                      name="valeur"
                ...
                <div class="modal fade" id="modalCenter1" tabindex="-1" aria-hidden="true">
                          <div class="modal-dialog modal-dialog-centered" role="document">
                            ...
                            <form action="<?php echo site_url("Aliment/insert"); ?>" method="post">  
                              <div class="modal-header">
                                <h5 class="modal-title" id="modalCenterTitle">Nouvelle  aliment</h5>
                                <button
                                  type="button"
                                  class="btn-close"
                                  data-bs-dismiss="modal"
                              ...
                              <div class="modal-body">
                                <div class="row">
                                  <div class="col mb-3">
                                    <label for="nameWithTitle" class="form-label">Libelle</label>
                                    <input
                                      type="text"
                                      id="nameWithTitle"
                                      class="form-control"
                                ...
                                <div class="row g-2">
                                  <div class="col mb-0">
                                    <label for="emailWithTitle" class="form-label">Categorie</label>
                                      <select name="idcategorie"  id="emailWithTitle" class="form-control" id="" >
                                ...
                                <div class="row g-2">
                                  <div class="col mb-0">
                                    <label for="emailWithTitle" class="form-label">Photo</label>
                                    <input
                                      type="file"
                                      id="emailWithTitle"
                                      name="photo"
...
<div class="modal fade" id="modalCenter2" tabindex="-1" aria-hidden="true">
                          <div class="modal-dialog modal-dialog-centered" role="document">
                            ...
                            <form action="<?php echo site_url("Aliment/insert"); ?>" method="post">  
                              <div class="modal-header">
                                <h5 class="modal-title" id="modalCenterTitle">Nouvelle  activité</h5>
                                <button
                                  type="button"
                                  class="btn-close"
                                  data-bs-dismiss="modal"
