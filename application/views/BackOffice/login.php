...
>
  <head>
    ...
    <!-- Page CSS -->
    <!-- Page -->
    <link rel="stylesheet" href="<?php echo site_url('asset/vendor/css/pages/page-auth.css')?>" />
    <!-- Helpers -->
            ...
            <div class="card-body">
              ...
              <div class="app-brand justify-content-center">
                <a href="index.html" class="app-brand-link gap-2">
                  ...
                  <span class="app-brand-text demo text-body fw-bolder">EKaly</span>
                </a>
              </div>
              <!-- /Logo -->
              <h4 class="mb-2">Bienvenue sur  eKaly</h4>
              <form id="formAuthentication" class="mb-3" action="<?php echo site_url('Login/checklogin')?>" method="POST">
                <div class="mb-3">
